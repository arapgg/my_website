...
<body>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="https://images.tokopedia.net/img/cache/900/VqbcmM/2020/8/31/69baee9b-9b62-4874-857e-ed1e3f13030a.jpg"
                    class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://images.tokopedia.net/img/cache/900/product-1/2017/11/13/0/0_5bfe0f3f-e1bc-4960-8ef2-0b5b0c6d69f3_700_453.jpg"
                    class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <div class="p-8 md:p-12 lg:px-16 lg:py-24">
            ...
            <div class="mx-auto mt-8 max-w-xl">
                <form action="#" class="sm:flex sm:gap-4">
                    <div class="sm:flex-1">
                        <input type="text" placeholder="Pintu kedap suara dan anti api..."
                    ...
                    <button type="submit"
                        class="group mt-4 flex w-full items-center justify-center gap-2 rounded-md bg-indigo-600 px-5 py-3 text-white transition focus:outline-none focus:ring focus:ring-blue-400 sm:mt-0 sm:w-auto">
    ...
    <div class="container grid grid-cols-3 gap-8 max-w-xl mx-auto py-8">
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli Jendela UPVC Sliding uk.2000x1000mm"
            ...
            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    Jendela UPVC Sliding uk.2000x1000mm
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 4.050.000</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli Pintu ABS Klasik uk.900x2100mm"
            ...
            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    Pintu ABS Klasik uk.900x2100mm
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 1.900.000</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli Jendela UPVC merk S plus, Garansi 10 tahun"
            ...
            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    Jendela UPVC merk S plus, Garansi 10 tahun
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 2.345.678</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli pintu kamar mandi UPVC uk 700x1950mm"
            ...
            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    pintu kamar mandi UPVC uk 700x1950mm
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 1.350.000</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli PBank(Magsafe) WiWU Core 10000mAh 15W"
            class="group block">
            <img src="https://images.tokopedia.net/img/cache/900/VqbcmM/2024/5/7/4bfd2dcc-8a9e-4b39-8d42-356e6186bd1c.jpg"
                alt="" class="aspect-square w-full rounded object-cover" />

            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    PBank(Magsafe) WiWU Core 10000mAh 15W
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 599.000</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli MiLi Key Finder Item Locator with case"
            class="group block">
            <img src="https://images.tokopedia.net/img/cache/900/VqbcmM/2024/5/3/ae35679a-a643-4326-8068-ed0b1b2afea7.jpg"
                alt="" class="aspect-square w-full rounded object-cover" />

            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    MiLi Key Finder Item Locator with case
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 239.900</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli Adidas Original Alphabounche Beyond"
            class="group block">
            <img src="https://images.tokopedia.net/img/cache/900/VqbcmM/2020/8/31/69baee9b-9b62-4874-857e-ed1e3f13030a.jpg"
                alt="" class="aspect-square w-full rounded object-cover" />
            ...
            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    Adidas Original Alphabounche Beyond
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 599.000</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli Adidas Original XPLR Junior/Women"
            class="group block">
            <img src="https://images.tokopedia.net/img/cache/900/VqbcmM/2020/8/31/13fa5042-2629-4e92-bb71-0518d9312229.jpg"
                alt="" class="aspect-square w-full rounded object-cover" />

            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    Adidas Original XPLR Junior/Women
                </h3>

                <p class="mt-1 text-sm text-gray-700">Rp. 799.000</p>
            </div>
        </a>
        <a href="https://wa.me/628170733339?text=Permisi min saya mau beli Adidas Original Court Vantage Blue S76199"
            class="group block">
            <img src="https://images.tokopedia.net/img/cache/900/product-1/2020/8/11/80845/80845_01bdf57e-f21c-4b2b-a7bc-0c8cd861c340_960_960.jpg"
                alt="" class="aspect-square w-full rounded object-cover" />

            <div class="mt-3">
                <h3 class="font-medium text-gray-900 group-hover:underline group-hover:underline-offset-4">
                    Adidas Original Court Vantage Blue S76199
                </h3>
